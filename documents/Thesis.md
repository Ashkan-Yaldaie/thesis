...
The other situation considered the possibility of destroying the PIR in the case of an intrusion immediately after entering the house. Will the owner still receive the SMS notification? The test result confirmed the  success of the security system although it is possible to damage the RasPi within about 12 seconds after the PIR’s signal is received to avoid uploading the video to the cloud and sending the SMS notification. So, it is recommended to keep the product somewhere hidden in the house. It is also recommended to hide the router and secure it with a good password.
