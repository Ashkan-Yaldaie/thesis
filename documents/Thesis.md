...
In the current chapter, three budget boards will be analysed. The most suitable board was chosen for the project, based on the comparison of the available functions and advantages.
