...
Today’s computer science students do not have the same skills like students in 1990’s, that is how Eben Upton felt. It might be due to the rise of more powerful computers and game consoles, so people do not have the programming skills of the earlier generation. That was the reason for the RasPi to come into the world with the help of Eben and his colleagues at the Cambridge University. (Richardson & Wallace 2013, vii) It might be interesting to know where the name "Raspberry Pi" came from? The project at its early stages was called  “ABC Micro” by the founders. The name "Raspberry Pi" is formed due to the long tradition of giving  fruit names to computer components and “Pi” comes from the word “Python”, it is the recommended programming language for the RasPi. (Upton & Halfacree 2014, 4)
