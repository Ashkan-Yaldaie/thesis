...
os.system("cvlc v4l2:///dev/video0 :sout='#transcode{vcodec=mp4v,vb=5000,scale=1,fps=30,acodec=mpga,ab=128,channels=1,\
samplerate=44100}:duplicate{dst=std{access=file,mux=ts,dst=clip_"+ str(fileName) +"}}' --run-time=10 vlc://quit")
```
