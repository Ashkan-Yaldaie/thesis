...
The tasks related to controlling the sockets by using home temperature and timer are completed in this subchapter. The cron table entry automation can be found in the chapter devoted to the creation of a graphical user interface.
